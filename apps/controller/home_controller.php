...
class HomeController extends AppController {
                    ...
                    if ($userAdmin != null) {
                        ...
                        if ($userAdmin->IsAktif == 1) {
                            ...
                            if (!$oke && $userAdmin->CabangId != $usercabang && $userAdmin->UserLvl < 4) {
                                ...
                                $this->persistence->SaveState("user_sbuid", $userAdmin->SbuId);
                            ...
                            $this->Set("error", "Nama Pemakai terdaftar tapi tidak aktif!"); //tampilkan pesan error
                        }
                    }else{
	...
	private function doLogin($username, $password, $cabid = 1) {
		$acl = AclManager::GetInstance();
