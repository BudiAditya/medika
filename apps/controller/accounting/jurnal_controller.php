...
class JurnalController extends AppController {
    ...
    public function index() {
        ...
        if (!$router->IsAjaxRequest) {
            ...
            if ($_GET["query"] == "") {
                $_GET["query"] = null;
                $settings["where"] = "(month(a.tgl_voucher) = ".$this->userAccMonth." And year(a.tgl_voucher) = ".$this->userAccYear.") And doc_status < 3 And a.entity_id = ".$this->userCompanyId;
            } else {
