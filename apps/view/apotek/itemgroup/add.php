...
<html>
<head>
	<title>ERAMEDIKA - Tambah Data Golongan Barang/Obat</title>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			var elements = ["GroupCode", "GroupName", "GroupDescs", "Simpan"];
...
<br/>
<fieldset>
	<legend><b>Tambah Data Golongan Barang/Obat</b></legend>
	<form id="frm" action="<?php print($helper->site_url("apotek.itemgroup/add")); ?>" method="post">
