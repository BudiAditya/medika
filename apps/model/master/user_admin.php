...
WHERE a.user_uid = ?id";
	...
	public function Insert() {
		$this->connector->CommandText =
"INSERT INTO sys_users(sbu_id,is_aktif, user_id, entity_id, cabang_id, user_pwd, user_lvl, user_name, user_email, allow_multiple_login, force_accounting_period, employee_id,a_cabang_id)
VALUES(?sbu_id,?is_aktif, ?user_id, ?entity_id, ?cabang_id, ?user_pwd, ?user_lvl, ?user_name, ?user_email, ?allow_multiple_login, ?force_accounting_period, ?employee_id, ?a_cabang_id)";
